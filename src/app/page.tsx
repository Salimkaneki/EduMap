...
import PageHeader from "./etablissements/_components/PageHeader";
import ViewControls from "./etablissements/_components/ViewControls";
import LoadingState from "./etablissements/_components/LoadingState";
import ErrorState from "./etablissements/_components/ErrorState";
import EmptyState from "./etablissements/_components/EmptyState";
import EtablissementGrid from "./etablissements/_components/EtablissementGrid";
import GoogleMapComponent from "./etablissements/_components/GoogleMapComponent";
import ModernSearchBar from "./etablissements/_components/ModernSearchBar";
...
import {
  ...
  getFilterOptions,
  getMapData,
} from "./etablissements/_services/etablissementService";
            ...
            <Card className="h-[calc(100vh-200px)] shadow-xl border-0">
              <CardContent className="p-0 h-full">
                <GoogleMapComponent
                  ...
                  onEtablissementSelect={(etab: MapEtablissement) => handleViewDetails(etab.id)}
