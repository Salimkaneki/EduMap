    ...
    const fetchData = async () => {
      try {
        ...
        const adaptedData: School = {
          ...
          admissionInfo: schoolData.admissionInfo || "Contactez l'établissement pour plus d'informations sur les admissions.",
          fees: schoolData.fees || "Contactez l'établissement pour plus d'informations sur les frais."
        };
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                {school.fees && (
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-800 mb-2">Frais de scolarité</h4>
        ...
        // Continuation du fichier SchoolDetailPage.tsx
// Continuation à partir de la section "Établissements similaires"
...
<div className="mt-12 border-t border-gray-200 pt-8">
  <div className="flex items-center justify-between mb-6">
    ...
    <button className="px-4 py-2 text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 transition-colors">
      Laisser un avis
    </button>
  </div>
  
  {/* Afficher quelques avis s'il y en a */}
  {school.reviews > 0 ? (
    <div className="space-y-6">
        ...
        <div className="flex items-start">
          ...
          <div className="ml-4 flex-1">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm text-gray-500">Il y a 2 mois</span>
            </div>
            ...
            <p className="text-gray-700">Très bon établissement avec des enseignants qualifiés et attentifs. Les infrastructures sont bien entretenues et les élèves bénéficient d'un environnement propice à l'apprentissage.</p>
          </div>
        </div>
      </div>
      
      {/* Exemple d'un autre avis */}
      <div className="bg-white p-6 rounded-xl border border-gray-200">
        <div className="flex items-start">
          <div className="flex-shrink-0">
          ...
          <div className="ml-4 flex-1">
            <div className="flex items-center justify-between">
              <h3 className="font-semibold text-gray-900">Sophie Martin</h3>
              <span className="text-sm text-gray-500">Il y a 3 mois</span>
            </div>
            <div className="flex items-center mt-1 mb-2">
              {[1, 2, 3, 4, 5].map((star) => (
            ...
            <p className="text-gray-700">Mon enfant a progressé énormément depuis qu'il a intégré cette école. Le personnel administratif est très réactif et l'équipe pédagogique est à l'écoute des besoins spécifiques de chaque élève.</p>
          </div>
        </div>
      </div>
      ...
      <div className="text-center">
        <button className="px-5 py-2 text-sm font-medium rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors">
          Voir tous les avis ({school.reviews})
        </button>
      </div>
    </div>
  ) : (
    <div className="bg-gray-50 p-8 rounded-xl text-center">
      ...
      <h3 className="text-lg font-semibold text-gray-800 mb-2">Aucun avis pour le moment</h3>
      <p className="text-gray-600 mb-4">Soyez le premier à partager votre expérience avec cet établissement.</p>
      <button className="px-5 py-2 text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 transition-colors">
        Laisser un avis
      </button>
    </div>
  )}
