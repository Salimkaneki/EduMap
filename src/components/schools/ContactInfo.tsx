...
export default function ContactInfo({ school }: ContactInfoProps) {
  const noContactInfo = !school.address && !school.contact && !school.email && !school.website;
  ...
  return (
    <div className="bg-gray-50 p-6 rounded-xl h-fit">
      ...
      {noContactInfo ? (
        <p className="text-gray-600">Nous n&apos;avons pas trouvé d&apos;informations de contact pour cet établissement.</p>
      ) : (
